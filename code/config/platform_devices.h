...
extern "C" {
        ...
        #ifdef CONFIG_SI7060
                /* Example temperature sensor SI7060 */
                I2C_SLAVE_DEVICE(I2C1, SI7060, 0x30, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_STANDARD);
        #endif

        #ifdef CONFIG_LSM303AH
                /* Example temperature sensor LSM303AH */
                 I2C_SLAVE_DEVICE(I2C1, LSM303AH_ACC, 0x1D, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_STANDARD);
                 I2C_SLAVE_DEVICE(I2C1, LSM303AH_MG, 0x1E, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_STANDARD);
        #endif
